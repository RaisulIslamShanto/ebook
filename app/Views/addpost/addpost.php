                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card">
                                    ...
                                    <a href="<?php echo base_url('article')?>">
                                        <div class="item">
                                            <div class="item-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#1abc9c" class="bi bi-file-earmark-text" viewBox="0 0 16 16">
                                                    <path d="M5.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1h-5zM5 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5zm0 2a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5z"></path>
                                                    <path d="M9.5 0H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8a2 2 0 0 0 2-2V4.5L9.5 0zm0 1v2A1.5 1.5 0 0 0 11 4.5h2V14a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1h5.5z"></path>
                                                </svg>
                                            </div>
                                            <h5 class="title">Article</h5>
                                            <p class="desc">An article with images and embed videos</p>
                                        </div>
                                    </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card">
                                    ...
                                    <a href="<?php echo base_url('gallery')?>">
                                        <div class="item">
                                            <div class="item-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#1abc9c" class="bi bi-images" viewBox="0 0 16 16">
                                            ...
                                            <p class="desc">A collection of image</p>
                                        </div>
                                    </a>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="card">
                                    <div class="card-body text-center">
                                    <a href="<?php echo base_url('sortedListpage')?>">
                                        <div class="item">
                                            <div class="item-icon">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="#1abc9c" class="bi bi-list-ol" viewBox="0 0 16 16">
                                            ...
                                            <h5 class="title">Sorted List</h5>
                                            <p class="desc">A List based Article</p>
                                        </div>
                                    </a>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <a href="<?php echo base_url('videopage')?>">
                                        <div class="item">
                                            ...
                                            <p class="desc">Video and embed videos</p>
                                        </div>
                                    </a>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <a href="<?php echo base_url('audiopage')?>">
                                        <div class="item">
                                            ...
                                            <p class="desc">Upload Audio and Create playlist</p>
                                        </div>
                                    </a>
                                    </div>
                                </div>
                                ...
                                <div class="card">
                                    ...
                                    <a href="<?php echo base_url('quizepage')?>">
                                        <div class="item">
                                            ...
                                            <h5 class="title">Trivia Quize</h5>
                                            <p class="desc">An article with images and embed videos</p>
                                        </div>
                                    </a>
                                    </div>
                                ...
                                <div class="card">
                                    ...
                                    <a href="<?php echo base_url('gallery')?>">
                                        <div class="item">
                                            ...
                                            <h5 class="title">Personality Quize</h5>
                                            <p class="desc">An article with images and embed videos</p>
                                        </div>
                                    </a>
                                    </div>
