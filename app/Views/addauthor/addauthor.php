                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Author Page</li>
                        </ol>
                        ...
                        <form action="<?php echo base_url('addauthor')?>" method="post">
                                ...
                                <div class="mb-3 form-check">
                                    <input type="checkbox" class="form-check-input" id="varified" name="varified" >
                                    <label class="form-check-label" for="exampleCheck1">Varified</label>
                                </div>
