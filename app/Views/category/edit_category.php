                ...
                <div class="row">
                            ...
                            <div class="card mb-4">
                                ...
                                <table class="table">
                                    <thead class="thead-dark">
                                        ...
                                        <? //= $value['category_name'] ;?></a></th>
                                        
                                        <td><a href="<?php //echo base_url('edit_category')?>">edit</a></td>
                                        <td><a href="<?php //echo base_url('delete_category')?>">delete</a></td>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body text-start">
                                <form action="<?= base_url('edit_category/update/'.$edit_category['id']) ?>" method="Post">
                                    <div class="mb-3">
                                        <label for="categoryname" class="form-label">Name </label>
                                        <input type="text" class="form-control" id="categoryname" value="<?= $edit_category['category_name']?>"
                                        name ="categoryname">
